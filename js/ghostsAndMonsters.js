(function() {
  ...
  window.GhostsAndMonstersGame = (function() {
    ...
    function GhostsAndMonstersGame(canvas, debugCanvas, statsCanvas) {
      var blockHeight, blockWidth, ghost, ground, groundLevelPixels, i, initHeadXPixels, j, leftPyamid, levels, myBlock, topOfPyramid, worldHeightPixels, worldWidthPixels, x, y, _ref,
        _this = this;
      ...
      initHeadXPixels = 100;
	  this.initpos = initHeadXPixels;
      groundLevelPixels = worldHeightPixels - (37 / 2);
      this.world.addImage("img/nature.jpg", {
        scaleX: 1.3,
        scaleY: 1.3
      });
      ...
      this.world.addImage("img/catapult.png", {
    ...
    GhostsAndMonstersGame.prototype.tick = function() {
		...
		var travel = this.head.easelObj.x - this.initpos;
		
		if(travel > 240){			
			this.world.easelStage.x = 0 - travel;
		}
		this.stats.update();
    };
